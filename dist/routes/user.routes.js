 ...
 *
 */
router.post('/create', [_middlewares.authVerify.verifyToken, _middlewares.authVerify.isAdmin, _middlewares.createUserValidator.checkDuplicateIdNumerOrEmail], userCtrl.createUser);
/**
 * @swagger
 * /api/users/listusers:
 *  get:
...
router.get('/listusers', [_middlewares.authVerify.verifyToken], userCtrl.getUsers);
/**
 * @swagger
...
router.post('/filterusers', [_middlewares.authVerify.verifyToken], userCtrl.getFilteredUsers);
/**
 * @swagger
...
router.get('/showuser/:id', [_middlewares.authVerify.verifyToken], userCtrl.getUserById);
/**
 * @swagger
...
router.put('/updateuser/:id', [_middlewares.authVerify.verifyToken, _middlewares.authVerify.isAdmin], userCtrl.updateUserById);
/**
 * @swagger
...
router["delete"]('/deluser/:id', [_middlewares.authVerify.verifyToken, _middlewares.authVerify.isAdmin], userCtrl.deleteUserById);
/**
 * @swagger
...
router.get('/followuser/:id', [_middlewares.authVerify.verifyToken], userCtrl.followUser);
/**
 * @swagger
...
router.get('/unfollowuser/:id', [_middlewares.authVerify.verifyToken], userCtrl.unFollowUser);
var _default = router;
